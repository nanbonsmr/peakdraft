...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are PeakDraft AI — a professional writing assistant. You help users with:
- Writing, editing, and improving content (blog posts, emails, social media, ads, etc.)
